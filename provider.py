...
# Add this to your provider.py file

def add_gaussian_noise(point_cloud, sigma=0.01):
    """
    Randomly jitter points. sigma is standard deviation.
    The input is expected to be a NumPy array of shape (B, N, 3).
    """
    B, N, C = point_cloud.shape
    assert C == 3
    
    # Generate Gaussian noise
    noise = sigma * np.random.randn(B, N, 3)
